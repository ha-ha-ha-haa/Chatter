...
const BlogData = [
  {
    image: "https://www.economy.pk/wp-content/uploads/2021/05/msft-microsoft-logo-2-3-1140x570.jpeg",
    ...
    <div>
      ...
      <Row>
        ...
        <Col>
          <CardGroup>
            <Card>
              <CardImg alt="Card image cap" src={"https://www.economy.pk/wp-content/uploads/2021/05/msft-microsoft-logo-2-3-1140x570.jpeg"} bottom width="100%" />
              <CardBody>
            ...
            <Card>
              <CardImg alt="Card image cap" src={bg2} bottom width="100%" />
              <CardBody>
                <CardTitle tag="h5">Card title</CardTitle>
                <CardSubtitle className="mb-2 text-muted" tag="h6">
                  Card subtitle
            ...
            <Card>
              <CardImg alt="Card image cap" src={bg3} bottom width="100%" />
              <CardBody>
                <CardTitle tag="h5">Card title</CardTitle>
                <CardSubtitle className="mb-2 text-muted" tag="h6">
                  Card subtitle
